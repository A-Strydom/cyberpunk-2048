...
- 🤖 **Autodrive Mode**: Watch the AI play automatically
...
4. Click **REBOOT** to restart the game
5. Click **Autodrive** to watch the AI play
...
- **Orange**: `#ff6b35` - Button accent color
